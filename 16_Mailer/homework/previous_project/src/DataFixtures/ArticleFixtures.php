...
class ArticleFixtures extends BaseFixtures implements DependentFixtureInterface
{
    ...
    public function __construct(ArticleContentProviderInterface $articleContentProvider, CommentContentProvider $commentContentProvider, FileUploader $articleFileUploader)
    {
