...
class Article
{
     ...
     * @Groups("main")
     * @Assert\NotBlank(message="Не указано название статьи")
     * @Assert\Length(min="3")
     */
    private $title;
     ...
     * @Groups("main")
     * @Assert\NotBlank(message="Не указано описание статьи")
     ...
     * @Assert\NotBlank(message="Не указан автор")
     */
    private $author;
    ...
    {
        return $this->getAuthor()->getAvatarUrl(40);
    }
